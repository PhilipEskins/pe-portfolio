      ...
      <div id="projectArea">
        ...
        <div id="first" className="mySlides">
          <div className="topPanel">
            ...
            <div className="center"><a href="https://dog-react.web.app/" target="_blank" rel="noopener noreferrer">View live version</a> | <a href="https://github.com/PhilipEskins/dog-guessing-game" target="_blank" rel="noopener noreferrer">View Github Repo</a><div className="center">Links open in a new window</div></div>
        ...
        <div id="second" className="mySlides">
          <div className="topPanel">
            ...
            <div className="center"><a href="https://disneyland-clone.firebaseapp.com/" target="_blank" rel="noopener noreferrer">View live version</a> | <a href="https://github.com/PhilipEskins/disneyland-clone" target="_blank" rel="noopener noreferrer">View Github Repo</a><div className="center">Links open in a new window</div></div>
            <div className="cutout"></div>
          </div>
          <div className="bottomPanel">
            <p>Skills used:</p>
        ...
        <div id="third" className="mySlides">
          <div className="topPanel">
            ...
            <div className="center"><a href="https://monopoly-4bd44.firebaseapp.com/" target="_blank" rel="noopener noreferrer">View live version</a> | <a href="https://github.com/PhilipEskins/monopoly" target="_blank" rel="noopener noreferrer">View Github Repo</a><div className="center">Links open in a new window</div></div>
            <div className="cutout"></div>
          </div>
          <div className="bottomPanel">
            <p>Skills used:</p>
        ...
        <div id="fourth" className="mySlides">
          <div className="topPanel">
            ...
            <div className="center"><a href="https://philipeskins.github.io/dog-game/" target="_blank" rel="noopener noreferrer">View live version</a> | <a href="https://github.com/PhilipEskins/dog-game" target="_blank" rel="noopener noreferrer">View Github Repo</a><div className="center">Links open in a new window</div></div>
            <div className="cutout"></div>
          </div>
          <div className="bottomPanel">
            <p>Skills used:</p>
